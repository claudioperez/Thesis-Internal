...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{Part II/admin/Figures//BRACE2 Overview.pdf}
    \caption{\BRACE{} platform user access.}
    \label{fig:interaction}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth,trim={0 2cm 0 0},clip]{Part II/admin/Figures//BRACE2 Database.pdf}
