...
\AxialRigidity & EA\CentroidLocation^\top & 0 & \mathbf{0} \\[4pt]
\mathbf{0} & \mathbf{0} & \mathbf{0} & \ShearRigidity \\[4pt]
0 & \mathbf{0} & \TwistRigidity & \mathbf{0} \\[4pt]
-\FrameBasis\times EA\CentroidLocation & -\FrameBasis^\times \CoupleRigidity & \mathbf{0} & \mathbf{0}
\end{bmatrix}.
\label{eq:G0-neg-m}
\end{equation}
where the centroidal flexural rigidity \(\ShearRigidity\) is defined: 
\begin{equation}
    \ShearRigidity \coloneq \CoupleRigidity - EA\CentroidLocation\otimes\CentroidLocation
