...
\item Local follower basis \(\{\frameBasis_k\}\) – Oriented with the current cross-section at each integration point; as the element deforms, these axes rotate.  Loads expressed in this frame (e.g., pressure normal to the surface, axial tension that always aligns with the current axis) “follow” the deformation.  
