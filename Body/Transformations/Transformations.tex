...
Equation~(\ref{eq:para-bases}) in the formulas of Box~\ref{box:fea}. 
...
\end{equation}
where $\bar{\mathbf{k}}_{ab}$ is the stiffness resulting from substitution of Equation~(\ref{eq:para-bases}) into the operators of Box~\ref{box:fea},
