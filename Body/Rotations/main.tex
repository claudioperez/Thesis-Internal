...
\chapter{The Rotation Group}\label{sec:rotations}
...
,  \\
[\bm{\Lambda}\bm{a}, \bm{\Lambda}\bm{c}, \bm{\Lambda}\bm{c}]&=[\bm{a}, \bm{b}, \bm{c}]
...
However, it is helpful to observe this implication from the rotation constraints in \eqref{eq:def-SO3}.}. 
The properties in \eqref{eq:def-SO3} for any 
...
while maintaining the constraints of \eqref{eq:def-SO3}.
