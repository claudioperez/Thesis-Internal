...
\end{equation*}
where recall $\PlaneShearShape:\Section\rightarrow\Section\otimes\Section$ is the Poisson flexural warping shape \eqref{eq:def-eight-shapes}. 
