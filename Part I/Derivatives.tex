...
the definition in \eqref{eq:dlinear} breaks down.
...
Extending \eqref{eq:dscalar} to a vector or tensor field
...
$$
where $\nabla_{\bm{u}} f$ is defined by \eqref{eq:dscalar}.
\end{itemize}
...
\item
  ...
  use of the linear directional derivative formula in \eqref{eq:dlinear}.
\end{itemize}
