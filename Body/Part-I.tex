...
Inelastic material response generally depends on the full continuum strain tensor, whose pointwise value in the body is lost in the process of dimensional reduction. 
Fiber section models reconstruct this state of strain by leveraging the plane section hypothesis of Euler-Bernoulli and Timoshenko beam theories, but this fails to account for cross-sectional warping and often furnishes unrealistic response. 
