...
The beam is modeled with fiber-section frame elements, so that the cross-section is
represented by a grid of $N$~integration points, each characterized by its
