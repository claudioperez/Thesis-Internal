...
The cost of the JVP scales with~$\nhost$, incurring one tangent propagation per
host-parameter direction. Thus forward mode is efficient when the number of host parameters \(\nhost\) is small relative to the dimension of the state \(\nstate\).
