...
A uniform mesh of 10, 2-node \ExactFrame{} elements is used, and the reference moment in \eqref{eq:fref} for \(\lambda = 1/8\) is applied in a single load step. 
...
The model discretization uses 100 2-node \ExactFrame{} finite elements, and the loading is applied in 200 steps under load factor control.
