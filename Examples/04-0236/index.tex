...
Following this event, Caltrans conducted an on-site inspection, augmented by unmanned aerial vehicles, and identified the following damage \cite{heninger_use_2023}:
\begin{itemize}
