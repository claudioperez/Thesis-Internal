...
\begin{figure}[H]
    ...
    \caption{Deformed shape of curved cantilever for Example~\ref{sec:frame-1007}.}
    \label{fig:bathe}
\end{figure}
...
\begin{center}
\begin{table}[H]%
\caption{End displacements \(\Delta \boldsymbol{x}(L)\) of the curved cantilever (Example~\ref{sec:frame-1007}) for a discretization with 8, 2-node \ExactFrame{I} elements.}
\label{tab:bathe}
\input{Examples/frame-1001/Tables/CantileverCurved.tex}
\end{table}
\end{center}
