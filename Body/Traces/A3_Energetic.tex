...
&=\begin{bmatrix}
\AxialRigidity & EA\CentroidLocation^\top & 0 & \mathbf{0} \\
EA\CentroidLocation & \CoupleRigidity % E\IntRoR 
& \mathbf{0} & \mathbf{0} \\
...
\ShiftN &= \mathbf{0},\\[2pt]
\ShiftNK &= -\Bigl(1 + EA\,\CentroidLocation\cdot (\ShearRigidity)^{-1}\CentroidLocation\Bigr)
