...
\item[Hognestad]
  ...
  \label{eq:hognestad}
  \end{equation}
  where $K$ (a scaling for strength) and $Z$ (strain softening slope) are model parameters. A hysteretic loading-reloading algorithm for this curve was proposed by \citet{yassin1994nonlinear}, which has been implemented in the widely used \texttt{Concrete02} material model of OpenSees \cite{mckenna_nonlinear_2010}.
%
