...
\cite{greenhill1883strength,ziegler1977principles} who found an {approximate} minimum buckling torque \(T_{\mathrm{cr}}\) given by:
\[
...
The analysis uses the \Spherical{} geometric transformation with both \texttt{None} and \texttt{Incr} interpolation and parameterization variants.
