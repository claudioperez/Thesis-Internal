...
\section{General solution for Poisson-homogeneous bodies}\label{sec:iesan-poisson}

When Poisson's ratio \(\nu\) is uniform, the boundary value problems \eqref{eq:bvp-plane-shapes} admit the closed form solutions:
\begin{subequations}
\begin{align}
\PlaneAxialShape&=-\nu\,\bm{r} \\
...
Combining \eqref{eq:iesan-displacement-1} and \eqref{eq:iesan-displacement-2} and using \eqref{eq:ph-plane-shapes} furnishes the particular solution for the complete Saint-Venant class:
\begin{equation}
\begin{aligned}
...
\cref{sec:iesan-plane}
\cref{sec:iesan-pi}
\cref{sec:iesan-pii}
\cref{sec:iesan-poisson}
