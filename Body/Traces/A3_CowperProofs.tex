...
\(\CentroidLocation \times(\bar{\bm{\theta}} \times \CentroidLocation)=\left(\|\CentroidLocation\|^2 \mathbf{1}-\CentroidLocation \otimes \CentroidLocation\right) \bar{\bm{\theta}}\) the second term furnishes:
\[
\int_{\Section}\CoordinateCentroid\times(\bar{\bm\theta}\times\CoordinateCentroid)\dA
=\CentroidStaticInertia\,\bar{\bm\theta},
\]
Hence with \(\CentroidLocation \equiv \SectionAverage{\bm{r}}\) by material homogeneity,
\[
\CentroidStaticInertia\,\bar{\bm\theta}
...
so that
\begin{equation}
\FrameBasis\times\bar\Theta\Big[\FrameBasis\otimes(\bar\Theta[\WarpShearShape{}]\times(\bm{r}-\CentroidLocation))\Big]
=-\,\bar\Theta[\WarpShearShape{}]^{\times},
\qquad
\FrameBasis\times\bar\Theta[\FrameBasis\otimes\Section[\WarpShearShape{}]]
=\Section[\WarpShearShape{}].
