...
\begin{enumerate}
    ...
    \item \emph{Update}\label{EuclidIsom::update} \(\bm{R}\) from nodal rotations \(\bm{\Lambda}_a\) and new chord \(\Delta\bm{x}\), then compute \(\bar{\bm{c}}\) using \eqref{eq:solve-cbar}.
\end{enumerate}
