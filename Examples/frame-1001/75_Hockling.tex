...
a torque \(T\,\mathbf{E}_1\) applied at its end \(\reflenx = L\). 
...
\end{equation*}
%
The simulation uses a discretization of 20 \ExactFrame{} elements for the rod, and the torque is applied in 65 increments with iterative and incremental load factor control. 
The analysis uses the \texttt{SFIN} isometry with both \texttt{None} and \texttt{Incr} interpolation and parameterization variants.
