...
Furthermore, the stable, encapsulated API exposed through the companion \Xara{} package is a catalyst for new research, eliminating barriers to integration with modern machine learning toolchains like JAX and PyTorch, which rely crucially on explicit state management. 
This is already being demonstrated by its adoption in novel studies on parameter sensitivities and surrogate modeling, empowering the community to build more complex and reliable research tools.