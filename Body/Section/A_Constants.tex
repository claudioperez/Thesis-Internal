...
From \cref{eq:section-linear-tangent}, it is evident that the complete response of a linear isotropic prism is characterized by the constant geometric cross section tensors:
\begin{equation*}
\left[
\begin{matrix}
    A \mathbf{1} 
