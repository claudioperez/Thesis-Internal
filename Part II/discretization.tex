...
This appendix presents a general approach for discretizing a large class of continuum equilibrium problems that are governed by partial differential equations to formulate a representative discrete internal force vector $\intern$. 
...
\paragraph{Tangent Stiffness}\label{tangent-stiffness}
