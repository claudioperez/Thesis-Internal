...
\begin{quote}
\noindent
The state of a structure as it experiences an event is assumed to be characterized by its displacement $\displ$ and velocity $\veloc$. It is governed by Newton's laws of motion (same as \eqref{eq:newton-discrete} but repeated here for convenience):
\begin{equation*}
