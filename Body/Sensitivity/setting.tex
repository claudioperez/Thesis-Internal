...
In the proposed approach, direct differentiation is only required for the minimal parameter set that is required to perform the analysis. 
...
material properties, fiber coordinates and areas, nodal
...
\]
where \(\ModelFamily\) denotes a fixed discretization of the physical model. 
