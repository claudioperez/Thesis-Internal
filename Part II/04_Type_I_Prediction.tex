...
as implemented on the \BRACE{} \gls{platform}. 
% \Cref{ch:discretization} discusses the formal theoretical structure that is inherent in representing continuous systems by the discrete problem of \cref{eq:newton-discrete} and \cref{ch:inelasticity} discusses the generalization of this theory to models that exhibit hysteresis.
