...
To this end, each
concrete predictor is packaged behind a \textbf{Strategy} object \cite{gamma2011design} that
...
Health metrics are immutable value objects \citep{fowler2013patterns} that bind three pieces of information: a \emph{tag} that identifies the physical
...
aggregation. 
Because all predictors emit metrics rather than
