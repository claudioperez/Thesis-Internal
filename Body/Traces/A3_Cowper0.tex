...
Then with \(\RotationAverage{\bm{W}_{(a)}} \in \mathbb{R}^{3 \times 2}\):
\begin{align*}
\bar{\bm{\theta}}^{(a)}(x) &= -x\,(\FrameBasis \times \bm{a}_\Omega) + \RotationAverage{\bm{W}_{(a)}}\,\bm{a}_\Omega, \\
...
&= -x\,\bm{a}_\Omega + \FrameBasis \times \big( -x\,(\FrameBasis \times \bm{a}_\Omega) + \RotationAverage{\bm{W}_{(a)}}\,\bm{a}_\Omega \big) \\
&= -x\,\bm{a}_\Omega + x\,\bm{a}_\Omega + \FrameBasis \times \RotationAverage{\bm{W}_{(a)}}\,\bm{a}_\Omega \\
&= (\FrameBasis \times \RotationAverage{\bm{W}_{(a)}})\,\bm{a}_\Omega,
\end{align*}
where we used $\FrameBasis \times (\FrameBasis \times \bm{a}_\Omega) = -\bm{a}_\Omega$ 
(since $\bm{a}_\Omega \perp \FrameBasis$). 
Hence:
\begin{equation*}
\bm{e}^{(a)}(x) = \begin{pmatrix} (\FrameBasis \times \RotationAverage{\bm{W}_{(a)}})\,\bm{a}_\Omega \\ 
...
+ x\,\RotationAverage{\PoissonFlexure}\,\bm{b}_{\Section} 
+ \RotationAverage{\FrameBasis \otimes \bm{\WarpShearIesan}}\,\bm{b}_{\Section} \\
&= (x\,\FrameBasis + \CenterTwistLocation)\,(\CenterShearLocation \cdot \bm{b}_{\Section}) 
- \tfrac{1}{2}x^2\,(\FrameBasis \times \bm{b}_{\Section}) 
+ x\,\RotationAverage{\PoissonFlexure}\,\bm{b}_{\Section} 
+ \RotationAverage{\FrameBasis \otimes \bm{\WarpShearIesan}}\,\bm{b}_{\Section}.
\end{align*}
where $\RotationAverage{\PoissonFlexure}\in\mathbb{R}^{3\times2}$, \(\RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}}\in\mathbb{R}^{3\times2}\),
...
+ x\,\left( \FrameBasis \otimes \CenterShearLocation + \RotationAverage{\PoissonFlexure} \right)\,\bm{b}_{\Section} 
+ \left( \CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} \right)\,\bm{b}_{\Section}.
...
+ \left( \FrameBasis \otimes \CenterShearLocation + \RotationAverage{\PoissonFlexure} \right)\,\bm{b}_{\Section}.
...
+ x\,\SectionAverage{\PoissonFlexure}\,\bm{b}_{\Section},
\end{align*}
using $\SectionAverage{\bm{r} - \CentroidLocation} = \mathbf{0}$ and $\SectionAverage{\bm{\WarpShearIesan}} = \mathbf{0}$.
...
+ x\,\left( \FrameBasis \otimes \CenterShearLocation + \RotationAverage{\PoissonFlexure} \right)\,\bm{b}_{\Section} \times \CentroidLocation 
 + \big( \CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} \big)\,\bm{b}_{\Section} \times \CentroidLocation.
\end{align*}
...
+ \CentroidLocation^{\times} \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}}.
...
+ \SectionAverage{\PoissonFlexure} - \bm{\Lambda}_1 \right)\,\bm{b}_{\Section} 
- \bm{\Lambda}_0\,\bm{b}_{\Section}.
\end{align*}
...
+ \SectionAverage{\PoissonFlexure} - \bm{\Lambda}_1 \big)\,\bm{b}_{\Section}.
\end{equation*}
...
+ x\,\FrameBasis \times \big( \FrameBasis \otimes \CenterShearLocation + \RotationAverage{\PoissonFlexure} \big)\,\bm{b}_{\Section} + \FrameBasis \times \big( \CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} \big)\,\bm{b}_{\Section} \\
&= \tfrac{1}{2}x^2\,\bm{b}_{\Section} 
+ x\,\FrameBasis \times \RotationAverage{\PoissonFlexure}\,\bm{b}_{\Section} 
+ \FrameBasis \times \big( \CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} \big)\,\bm{b}_{\Section},
\end{align*}
...
&\quad + x\,\Big( -\FrameBasis \otimes \CentroidLocation + \FrameBasis \times \RotationAverage{\PoissonFlexure} \Big)\,\bm{b}_{\Section} \\
&\quad + \Big( (\FrameBasis \times \CentroidLocation) \otimes \CenterShearLocation 
+ \SectionAverage{\PoissonFlexure} - \bm{\Lambda}_1 
+ \FrameBasis \times (\CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}}) \Big)\,\bm{b}_{\Section}.
\end{align*}
...
+ \SectionAverage{\PoissonFlexure} - \bm{\Lambda}_1 
+ \FrameBasis \times (\CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}}).
\label{eq:def-Gamma0}
\end{align}

Thus, because \(\FrameBasis \times \RotationAverage{\PoissonFlexure} = \mathbf{0}\):
\begin{equation}
...
0 & \mathbf{0}^\top & 1 & (\CenterShearLocation + (\RotationAverage{\PoissonFlexure})_\parallel)^\top \\[4pt]
\mathbf{0} & -\FrameBasis^\times & \mathbf{0} & (\RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} + \CenterTwistLocation \otimes \CenterShearLocation)_\perp
\end{pmatrix}
...
\begin{itemize}
\item $\bm{\Lambda}_1 = \CentroidLocation^\times \RotationAverage{\PoissonFlexure} = \mathbf{0}$
\item $\bm{\Lambda}_0 = \CentroidLocation^\times \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}} = \mathbf{0}$
\item $\bm{\Gamma}_1 = \FrameBasis \times \RotationAverage{\PoissonFlexure}$
\item $\bm{\Gamma}_0 = \SectionAverage{\PoissonFlexure} + \FrameBasis \times (\CenterTwistLocation \otimes \CenterShearLocation + \RotationAverage{\FrameBasis\otimes\bm{\WarpShearIesan}})$
\end{itemize}
...
\begin{equation}
(\bm{\Gamma}_0)_\perp = \SectionAverage{\PoissonFlexure} 
