...
\begin{table}[H]
    ...
    Symbol & Units & & Description \\ \midrule
        ...
        \LightRule 
        \(\AxialRigidity\) & & \eqref{eq:def-axial-rigidity} & Axial rigidity. \\
        \(\AxialCoupling\) & & \eqref{eq:def-axial-rigidity} & First moment vector. \\
        \(\CoupleRigidity\) & \Length{4} & \eqref{eq:def-j-origin} & Second moment tensor. \\
        \(\TwistRigidity\) & \Length{4} & \eqref{eq:def-j-origin} & Saint Venant torsional rigidity \\
