...
\begin{figure}
    \centering
    \resizebox{0.3\linewidth}{!}{\input{Body/Library/element}}
    \resizebox{0.3\linewidth}{!}{\input{Body/Library/section}}
    \resizebox{0.3\linewidth}{!}{\input{Body/Library/transform}}
