...
\[
\mathbf I = \int_{\Section}\big(\WarpShearShape{}-\bm{r}\big)\otimes(\FrameBasis\times\bm{r})\mathrm{~d}A
=\underbrace{\int_{\Section}\WarpShearShape{}\otimes(\FrameBasis\times\bm{r})\mathrm{~d}A}_{\mathbf A}
...
Then
\[
\mathbf A=\int_{\Section}\WarpShearShape{}\otimes\FrameBasis\times\nabla f\mathrm{~d}A.
\]
