...
rule and the \texttt{section} field is used homogeneously. 
However, all non-prismatic elements may alternatively be provided with an array of
...
\begin{enumerate}
    ...
    \item[T3.]\label{lib:T3} \texttt{Corotational} \cite{nour-omid1991finite}
    \item[T4.]\label{lib:T4} \texttt{Spherical} \cite{perez2024nonlinear}
\end{enumerate}
...
Lagrange (\(C^0\)) \\
\ExactFrame (Displ.) & Exact & - & Type III & Section & Lagrange
(\(C^0\)) \\
\bottomrule
\end{longtable}
