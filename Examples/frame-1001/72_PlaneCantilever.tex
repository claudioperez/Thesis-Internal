...
is given by \(\boldsymbol{x}_0(\xi) = \xi\,\mathbf{E}_1\).
...
\end{equation*}
%
where \(\vartheta\) parameterizes the rotation \(\boldsymbol{\Lambda}(\xi) = \operatorname{Exp} \vartheta(\xi) \, \mathbf{E}_3\). This result is derived in Appendix~\ref{sec:closed-solution}. 
