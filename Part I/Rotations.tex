...
It is indeed these properties alone that ensure any such map \(\bm{\Lambda}\) acts linearly on vectors\footnote{The linearity of $\mathrm{SO}(n)$ is more commonly specified directly by taking it as a subgroup of the general linear group, $\mathrm{GL}(n)$ (see e.g. \cite{artin1991algebra}).
