...
\begin{itemize}
    ...
    \item Any Class I trace (\cref{def:class-1}) is compatible with Type 3 beam finite elements via a Petrov-Galerkin formulation \eqref{eq:petrov-section}, which preserves the classical section resultants. However, most Class I traces result in an asymmetric tangent stiffness.
