...
% Furthermore, much of this literature precipitates in specialized element types whose implementations are difficult to validate in combination, difficult to embed in workflows requiring gradient information, and are not amendble to adaptive model refinement algorithms or integration with emerging standards in building information modeling like IFC. 
