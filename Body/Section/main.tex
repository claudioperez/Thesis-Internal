...
This section develops a constitutive framework for a broad class of nonlinear rod theories. The construction is motivated by enhanced strain methods in finite element analysis, in which the compatible strain is augmented by additional modes that do not enter the admissible stress work.
