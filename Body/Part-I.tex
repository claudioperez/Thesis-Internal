...
This approach yields acceptable accuracy when a uniaxial material model can sufficiently capture the inelastic material response and boundary conditions are simple.
...
A more accurate approach for reconstructing a multiaxial strain state introduces auxiliary kinematic fields in the formulation of the beam theory that model this warping \citep{lecorvec2012nonlinear,klinkel2003anisotropic}. 
When no limit is placed on the number of warping fields, it is possible to represent a continuum to any desired accuracy. 
However such models are often cumbersome, and it is preferable to forgo auxiliary warping fields altogether whenever possible.
...
The developments in this work are restricted to the following setting [TODO: Elaborate.]:
\begin{itemize}
