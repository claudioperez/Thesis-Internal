...
\begin{center}
\begin{table}[H]%
\caption{End displacements \(\Delta \boldsymbol{x}(L)\) of the curved cantilever (Example~\ref{sec:frame-1007}) for a discretization with 8, 2-node \ExactFrame{} elements.}
\label{tab:bathe}
